...
declare_id!("58q3u8kreouaKsVSwKxPqTP8eSu5pz6xXfHkAkPbdMP5");

const HAPPINESS_INCREASE: u32 = 10;
const HAPPINESS_DECREASE: u32 = 5;
const HAPPINESS_DECREASE_PERIOD: i64 = 60; // Time in seconds
...
pub mod solanapdas {
    ...
    pub fn feed_pet(ctx: Context<FeedPet>, amount: u64) -> ProgramResult {
        ...
        (&mut ctx.accounts.pet).has_been_fed = true;
        Ok(())
    }
    ...
    pub fn check_for_unfed(ctx: Context<CheckForUnfed>) -> ProgramResult {
        ...
        if time_since_last_fed >= HAPPINESS_DECREASE_PERIOD && time_since_last_happiness_decrease >= HAPPINESS_DECREASE_PERIOD && pet.happiness != 0 {
